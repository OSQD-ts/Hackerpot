...
const SCHEMA: Record<string, string[]> = {
  ...
  ftp: ["enabled", "port", "host", "banner", "max_auth_attempts", "drop_above_score", "max_connections", "interactive", "accept_on_attempt", "max_commands", "max_command_length", "max_session_ms"],
  telnet: ["enabled", "port", "host", "banner", "hostname", "max_auth_attempts", "drop_above_score", "max_connections", "interactive", "accept_on_attempt", "max_commands", "max_command_length", "max_session_ms"],
  syslog: ["enabled", "host", "port", "protocol", "format", "facility", "severity", "hostname", "min_score", "max_bytes", "include_body"],
